...
class DeviationServiceTest {
    ...
    @Test
    void updateDeviationStatus_rejectsInvalidTransition() {
        Long orgId = 1L;
        Long userId = 5L;
        ...
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class, () -> service.updateDeviationStatus(
                orgId,
                userId,
                deviationId,
                new UpdateDeviationStatusRequest(DeviationStatus.IN_PROGRESS, null)
